package edu.lk.ijse.projectgym.demo76promax.Modal;//package edu.lk.ijse.projectgym.demo76promax.Modal;
//
...
//    }
//
//    public  ResultSet getOwnerInformation() throws SQLException, ClassNotFoundException {
//        Connection connection = Dbconnection.getObject().getConnection();
